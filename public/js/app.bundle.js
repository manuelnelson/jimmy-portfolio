...
angular.module('portfolio').controller('ContactController', __webpack_require__(5));
...
angular.module('portfolio').directive('navigation', __webpack_require__(6)).directive('workTile', __webpack_require__(7));
...
angular.module('portfolio').factory('browserWidth', __webpack_require__(8));
...
__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../styles/site.scss\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"angular-scroll\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"angular-touch\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
